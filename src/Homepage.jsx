...
const menuItems = [
  { icon: <ClipboardList size={40} />, label: 'Inventory', path: '/dashboard?tab=INVENTORY' },
  { icon: <Calculator size={40} />, label: 'Costing Calculator', path: '/dashboard?tab=COSTING' },
  { icon: <FolderOpen size={40} />, label: 'Records', path: '/dashboard?tab=RECORDS' },
  { icon: <Edit3 size={40} />, label: 'Orders', path: '/dashboard?tab=ORDER' },
];
...
const Homepage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-100 to-blue-100 flex flex-col items-center justify-center text-gray-800">
      <img src="/images/bite_up_logo-removebg-preview.png" alt="BiteUP Logo" className="w-96" />
